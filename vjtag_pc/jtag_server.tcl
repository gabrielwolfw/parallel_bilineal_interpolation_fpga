...
set VJTAG_ADDR_WIDTH 16 ; # Ancho de dirección para SETADDR (16 bits - 64KB completo)
...
proc IncomingData {sock} {
    ...
    if {[eof $sock] || [catch {gets $sock line}]} {
        ...
        switch -exact -- $cmd {
            ...
            "SETADDR" {
                set addr [lindex $parts 1]
                # SETADDR usa VJTAG_ADDR_WIDTH (16 bits), no VJTAG_DATA_WIDTH
