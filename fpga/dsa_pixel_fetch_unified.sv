//============================================================
// dsa_pixel_fetch_unified.sv (versión compatible Quartus)
...
module dsa_pixel_fetch_unified #(
    ...
    // Salidas SIMD (señales individuales para Quartus)
    output logic                    simd_fetch_valid,
    output logic [7:0]              simd_p00_0,
    output logic [7:0]              simd_p00_1,
    output logic [7:0]              simd_p00_2,
    output logic [7:0]              simd_p00_3,
    output logic [7:0]              simd_p01_0,
    output logic [7:0]              simd_p01_1,
    output logic [7:0]              simd_p01_2,
    output logic [7:0]              simd_p01_3,
    output logic [7:0]              simd_p10_0,
    output logic [7:0]              simd_p10_1,
    output logic [7:0]              simd_p10_2,
    output logic [7:0]              simd_p10_3,
    output logic [7:0]              simd_p11_0,
    output logic [7:0]              simd_p11_1,
    output logic [7:0]              simd_p11_2,
    output logic [7:0]              simd_p11_3,
    output logic [15:0]             simd_a_0,
    output logic [15:0]             simd_a_1,
    output logic [15:0]             simd_a_2,
    output logic [15:0]             simd_a_3,
    output logic [15:0]             simd_b_0,
    output logic [15:0]             simd_b_1,
    output logic [15:0]             simd_b_2,
    output logic [15:0]             simd_b_3,
    ...
    //========================================================
    // Señales internas de fetch SIMD (como arrays internamente)
    //========================================================
    ...
    //========================================================
    // Conversión de arrays a señales individuales
    //========================================================
    always_comb begin
